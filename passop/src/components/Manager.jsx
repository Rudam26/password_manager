...
const Manager = () => {
    ...
    return (
        <>
            ...
            <div className="absolute top-0 -z-10 h-full w-full bg-green-50"><div className="absolute bottom-auto left-auto right-0 top-0 h-[500px] w-[500px] -translate-x-[30%] translate-y-[20%] rounded-full bg-[rgba(249,247,252,0.98)] opacity-50 blur-[80px]"></div></div>
